...
import com.example.hotel.config.StorageProperties;
import com.example.hotel.exception.StorageException;
import com.example.hotel.exception.StorageFileNotFoundException;
...
public class FileSystemStorageServiceImpl implements StorageService{
	...
	public void store(MultipartFile file, String storedFilename) {
		try {
			...
			throw new StorageException("Failed to store empty file", e);
		}
	}
